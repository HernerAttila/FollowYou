...
public class ServerCommunication {
    ...
    public void SendLocation(double latitude, double longitude, String Time) {
        SendDataObject[] sendDataArray = new  SendDataObject[4];
        SendDataObject sendData = new SendDataObject(latitude,longitude,Time,this.USER_ID,1);
